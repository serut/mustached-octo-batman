...
$screenshots_path = '/opt/callofduty4/pb/svss';		// path must contain the file pbsvss.htm, it may be local or remote (beginning with http:// or ftp://user:pass@hostname/ , it may be limited to webserver's IP)
